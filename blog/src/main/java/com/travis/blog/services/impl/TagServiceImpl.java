...
public class TagServiceImpl implements TagService
{
    ...
    public void deleteTag(UUID id) {
        ...
        tagRepository.findById(id).ifPresent(tag -> {
            ...
            {
              throw new IllegalStateException("Cannot delete tags with post");
            }
    ...
    public Tag getTagById(UUID id) {
        return tagRepository.findById(id).orElseThrow(() -> new EntityNotFoundException("Tag not found with id"));
    }
